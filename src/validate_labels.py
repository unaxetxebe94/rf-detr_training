...
try: 
    with open("label_validation_params.yaml") as f:
        params = yaml.safe_load(f)
    ANNOTATIONS_PATH = params["annotations-path"]
    IMAGES_DIR = params["images-dir"]
    SHOW_MASKS = params["show-masks"]
    RESIZE = params["resize"]
    OUT_DIR = params["out-dir"]
